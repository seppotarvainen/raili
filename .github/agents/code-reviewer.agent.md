...
You should the following resources in your prompt:
- **show-diff-resource**: contains **all changes on this branch**, including work from previously completed parts (pt1, pt2, etc.) that are already in `.issues/3_done/`
