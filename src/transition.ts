...
// Backwards-compatible behavior: if a transitions map contains exactly one non-default key,
...
export function resolveTransition(
  ...
  // No legacy fallback: unknown outcomes must be explicitly handled via a matching key or `default`.
  return null;
}
